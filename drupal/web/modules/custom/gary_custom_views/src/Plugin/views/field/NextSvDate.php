...
/**
 * @file
 * Definition of Drupal\gary_custom_views\Plugin\views\field\NextSvDate
 */
 ...
 *
 * @ViewsField("field_next_sv_date")
 */
class NextSvDate extends FieldPluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
  	$form['field_info'] = [
      '#type' => 'item',
      '#title' => t('Next SV Date Info'),
  	  '#description' => t('This field will look up the next site visit task associated with the project node and display its due date'),
      ];
  ...
  public function query() {
    ...
    $sql = "SELECT dd.field_task_due_date_value task_due_date
                ...
                limit 0,1";
    $params = [];
    $this->field_alias = $this->query->addField(NULL, "(".$sql.")", 'field_next_sv_date', $params);
